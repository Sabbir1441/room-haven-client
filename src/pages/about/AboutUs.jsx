            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex justify-start gap-6">
                        <button className="px-6 py-3 bg-[#0A92B9] text-white rounded-full shadow-lg hover:bg-[#0a93b9a5] transition duration-200">
                            Learn More
                        </button>
                        <button className="px-6 py-3 bg-transparent border-2 border-[#0A92B9] text-[#0A92B9] rounded-full hover:bg-[#0A92B9] hover:text-white transition duration-200">
                            Connect Us
                        </button>
                    </div>
                </div>
